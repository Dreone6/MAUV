...
export function HomeDashboardDark({ onNavigate }: HomeDashboardProps) {
  ...
  const getPhaseForDay = (day: number) => {
    if (day >= 1 && day <= 5) return { name: 'menstrual', color: '#ef4444', bgGradient: 'from-red-500 to-red-600', textColor: 'text-red-400' };
    if (day >= 6 && day <= 13) return { name: 'follicular', color: '#ec4899', bgGradient: 'from-pink-500 to-pink-600', textColor: 'text-pink-400' };
    if (day >= 14 && day <= 16) return { name: 'ovulation', color: '#a855f7', bgGradient: 'from-purple-500 to-purple-600', textColor: 'text-purple-400' };
    return { name: 'luteal', color: '#3b82f6', bgGradient: 'from-blue-500 to-blue-600', textColor: 'text-blue-400' };
  };
  ...
  const trackingCards = [
    ...
    { id: 'work', label: 'Work', icon: <Briefcase className="w-6 h-6 text-gray-400" />, color: 'text-gray-400' },
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              <button 
                ...
                className="w-10 h-10 rounded-full bg-gray-700/80 flex items-center justify-center hover:bg-gray-600/80 transition-colors shadow-md relative"
              >
      ...
      <div className="max-w-md mx-auto px-6 py-8 pb-24 space-y-6">
        ...
        <div className="flex gap-2">
          {weekDays.map((day, idx) => {
            ...
            return (
              <button
                key={idx}
                className={`flex-1 rounded-2xl transition-all duration-200 ${ day.isToday
                    ? `bg-gradient-to-br ${phase.bgGradient} text-white shadow-xl scale-105`
                    : 'bg-gray-800/70 hover:bg-gray-700/70 shadow-lg hover:shadow-xl border border-gray-700/50'
                }`}
              >
                <div className="p-2 text-center">
                  ...
                  <p className={`text-lg ${day.isToday ? 'text-white' : 'text-gray-200'}`}>
                    {day.date}
                  </p>
                  {day.hasEvent && (
                    <div className={`w-1.5 h-1.5 rounded-full mx-auto mt-1 ${ day.isToday ? 'bg-white' : ''
                    }`} 
        ...
        {/* Amara Tips Card */}
        <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 rounded-3xl p-5 border border-purple-700/50 shadow-xl">
          <div className="flex gap-4">
            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-pink-500 flex items-center justify-center text-white flex-shrink-0 shadow-lg">
              <img 
            ...
            <div className="flex-1">
              <h3 className="text-gray-200 mb-2">Amara Tips for Today</h3>
          ...
          {trackingCards.map((card) => {
            ...
            return (
              <button
                ...
                className={`bg-gray-800/80 hover:bg-gray-700/80 rounded-2xl p-3 flex flex-col items-center justify-center gap-2 transition-all duration-200 hover:scale-105 active:scale-95 shadow-lg hover:shadow-xl border relative ${ isLogged ? 'border-purple-500 bg-purple-900/30' : 'border-gray-700/50'
                }`}
              >
                {isLogged && (
                ...
                <p className="text-xs text-gray-300 text-center whitespace-pre-line leading-tight">
                  {card.label}
                </p>
              </button>
            );
        ...
        {/* Insights Section */}
        <div className="bg-gray-800/80 rounded-3xl p-6 border border-gray-700/50 shadow-xl">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-lg text-gray-200">Health Insights</h3>
            <button 
          ...
          <div className="space-y-4">
            {/* Cycle Consistency */}
            <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-green-900/30 to-emerald-900/30 rounded-2xl shadow-md border border-green-700/30">
              ...
              <div className="flex-1">
                <h4 className="text-sm text-gray-200 mb-1">Cycle Consistency</h4>
                <p className="text-xs text-gray-400">Your cycle has been regular (28 days avg) for 3 months</p>
              </div>
            </div>

            {/* Sleep Pattern */}
            <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-blue-900/30 to-indigo-900/30 rounded-2xl shadow-md border border-blue-700/30">
              ...
              <div className="flex-1">
                <h4 className="text-sm text-gray-200 mb-1">Sleep Quality</h4>
                <p className="text-xs text-gray-400">Average 7.5 hours • Better during follicular phase</p>
              </div>
            </div>

            {/* Energy Levels */}
            <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-orange-900/30 to-amber-900/30 rounded-2xl shadow-md border border-orange-700/30">
              ...
              <div className="flex-1">
                <h4 className="text-sm text-gray-200 mb-1">Energy & Activity</h4>
                <p className="text-xs text-gray-400">Peak energy days 8-14 • 3 workouts logged this week</p>
              </div>
            </div>

            {/* Common Symptoms */}
            <div className="flex items-start gap-3 p-4 bg-gradient-to-r from-purple-900/30 to-pink-900/30 rounded-2xl shadow-md border border-purple-700/30">
              ...
              <div className="flex-1">
                <h4 className="text-sm text-gray-200 mb-1">Well-being Summary</h4>
                <p className="text-xs text-gray-400">Mood: Positive • Hydration: 6 glasses/day • PMS: Mild</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* Bottom Navigation */}
      <div className="fixed bottom-0 left-0 right-0 bg-gray-900/95 backdrop-blur-sm border-t border-gray-700/50 shadow-2xl">
        <div className="max-w-md mx-auto px-6 py-3">
          <div className="flex items-center justify-around relative">
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 transition-colors ${ selectedNav === 'calendar' ? 'text-purple-400' : 'text-gray-500'
              }`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 transition-colors ${ selectedNav === 'insights' ? 'text-purple-400' : 'text-gray-500'
              }`}
            >
            ...
            >
              <div 
                ...
                style={{
                  boxShadow: '0 8px 16px rgba(147, 51, 234, 0.4), 0 4px 8px rgba(236, 72, 153, 0.3), 0 2px 4px rgba(0, 0, 0, 0.2), inset 0 -2px 4px rgba(0, 0, 0, 0.2), inset 0 2px 4px rgba(255, 255, 255, 0.2)',
                }}
              >
                <img 
                  src={image_4181731f1825e464f60d30194016a6b9994ed07a} 
              ...
              <span className="absolute -bottom-4 left-1/2 -translate-x-1/2 text-xs text-purple-400 whitespace-nowrap">
                Amara AI
              </span>
            </AmaraNavButton>
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 transition-colors ${ selectedNav === 'chat' ? 'text-purple-400' : 'text-gray-500'
              }`}
            >
            ...
            <button
              ...
              className={`flex flex-col items-center gap-1 transition-colors ${ selectedNav === 'partner' ? 'text-purple-400' : 'text-gray-500'
              }`}
            >
