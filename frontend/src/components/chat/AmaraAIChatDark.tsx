...
export function AmaraAIChatDark({ onBack, onNavigate }: AmaraAIChatProps) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex flex-col">
      ...
      <div className="bg-gray-800/50 border-b border-gray-700/30 shadow-md">
        <div className="max-w-md mx-auto px-6 py-4">
          <div className="flex items-center gap-3">
            <AmaraAvatar />
            <div>
              <h2 className="text-gray-200">Amara AI</h2>
              ...
              <div className={`flex gap-2 max-w-[80%] ${message.type === 'user' ? 'flex-row-reverse' : 'flex-row'}`}>
                ...
                <div
                  className={`rounded-2xl px-4 py-3 shadow-lg ${
                    message.type === 'amara'
                      ? 'bg-gray-700/80 text-gray-200 rounded-tl-sm border border-gray-600/50'
      ...
      {/* Input Area */}
      <div className="fixed bottom-20 left-0 right-0 bg-gray-900/95 backdrop-blur-sm border-t border-gray-700/50 shadow-xl">
        <div className="max-w-md mx-auto px-6 py-4">
          <div className="flex items-center gap-3">
            <input
              type="text"
              ...
              className="flex-1 bg-gray-700/80 rounded-full px-5 py-3 text-gray-200 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-400 shadow-md border border-gray-600/50"
            />
            <button
              onClick={handleSend}
