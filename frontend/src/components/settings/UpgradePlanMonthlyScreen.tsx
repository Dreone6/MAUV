...
interface UpgradePlanMonthlyScreenProps {
  onBack: () => void;
  onContinue: () => void;
  onSwitchToYearly: () => void;
}

export function UpgradePlanMonthlyScreen({ onBack, onContinue, onSwitchToYearly }: UpgradePlanMonthlyScreenProps) {
      ...
      <div className="px-6 pt-12 pb-6">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-baseline justify-center gap-1 mb-8">
            <span className="text-5xl text-gray-900">$4.99</span>
