...
const AVATARS = [
  { id: 'fairy_1', emoji: '🧚‍♀️', name: 'Luna Fairy', color: 'from-purple-400 to-pink-400' },
  { id: 'fairy_2', emoji: '✨', name: 'Sparkle Fairy', color: 'from-blue-400 to-purple-400' },
  { id: 'fairy_3', emoji: '🌸', name: 'Blossom Fairy', color: 'from-pink-400 to-rose-400' },
  { id: 'fairy_4', emoji: '💜', name: 'Violet Fairy', color: 'from-purple-500 to-indigo-400' },
  { id: 'fairy_5', emoji: '🌙', name: 'Moon Fairy', color: 'from-indigo-400 to-blue-400' },
  { id: 'fairy_6', emoji: '🌺', name: 'Hibiscus Fairy', color: 'from-rose-400 to-pink-500' },
];
